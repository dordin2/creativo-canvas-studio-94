...
const InventoryPanel = () => {
  ...
  return (
    <div className="fixed top-20 right-4 z-[9999] bg-white rounded-lg shadow-xl w-[320px] h-[70vh] max-h-[90vh] overflow-hidden flex flex-col animate-fade-in" style={{ zIndex: 9999 }}>
